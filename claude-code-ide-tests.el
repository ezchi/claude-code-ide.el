...
(ert-deftest claude-code-ide-test-get-terminal-input-robustness ()
  ...
  (with-temp-buffer
    ...
    (erase-buffer)
    (insert "claude > previous command\nresponse here\nclaude > current typing")
    (let ((stale-prompt-start (save-excursion
                                (goto-char (point-min))
                                (search-forward "claude > ")))
          (cursor (point-max)))
...
(ert-deftest claude-code-ide-test-strip-terminal-ui-suffix ()
  "Test stripping the Claude TUI footer and status content."
  (let ((input "my actual prompt\n\n▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄\n workspace (/Users/ezchi/projects/claude-code-ide)"))
    (should (equal (claude-code-ide--strip-terminal-ui-suffix input) "my actual prompt")))
  (let ((input "my prompt\n╰──────────────────────────────────────────────────────────────────────────╯\n\n                                                                ? for shortcuts"))
    (should (equal (claude-code-ide--strip-terminal-ui-suffix input) "my prompt")))
